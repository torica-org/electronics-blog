...
ラダーはパイロットの安全な飛行を実現するための，**電装における最優先製作物**である．

無論，記録を伸ばすための偏流飛行にも不可欠である．

ここでは，26代機 REWRITEに搭載したラダーレバーについてまとめる．
...
- [要求2] より，およそ1~2kgのラジアル荷重に耐えるセンサーにより角度を直接取得するか，何らかの方法で「操舵力」を直接取得する．
- [要求2] より，復元力は引きバネにより得る（引っ掛ける場所さえあれば良いため）．
- [要求3] より，コストの問題から，マイコンを右レバーにのみ搭載し，サーボモータの制御信号を生成する．
  - 左レバーはマイコンを用いず，およそ1700mmのケーブルを経て右レバーに接続する．

## 分析
### センサー
- 抵抗式ポテンショメータには回転トルクが少なく非常に好ましいものがある（例. RDC50 : 25代機 竜海のラダーレバーで採用）が，[要求 2] より軸におよそ1~2kgの負荷がかかるため，センサーの物理的破損や角度読み取り誤差増大の恐れがある．
